...
@section('title', 'تسجيل الدخول - الطالب')
...
@section('content')
    ...
    <h3 style="position: relative; text-align: center;">
        <i class="bi bi-box-arrow-in-right me-2"></i>تسجيل الدخول - الطالب
        <a href="{{ route('home') }}" style="color: #fff; text-decoration: none; position: absolute; left: 0px; top: 50%; transform: translateY(-50%);">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('student.login') }}" method="POST">
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{ route('student.register') }}" class="link-custom">سجل الآن</a>
                    </div>
                </form>
            </div>
        </div>
